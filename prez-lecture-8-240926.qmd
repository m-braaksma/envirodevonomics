...
- Context: Brazilian Amazon 2000-2019
    ...
    - In the mid-2000s, the government implemented policies reduce deforestation rates
- Methods:
...
where $i \in {1, 2, ..., N}$ represents farms, $t \in \{ 2000, 2001, ..., 2019 \}$ years, $G_{i}^{type} = g \in \{2005, 2006, ..., 2019\}$ treatment cohorts of each type, $C_{i} = 1$ the control group of never-treated farms, and $\Delta Y_{ig-1,t} = Y_{i,t} - Y_{i,g-1}$ the evolution of outcome $Y \in {\text{IHS(deforestation area), IHS(reforestation area)}}$ in a given year $t$ relative to the year before treatment $g - 1$

- Equivalent to a two-period/two-group difference-in-differences estimator that compares the average outcome evolution of the treated group in year $t$, post-treatment, relative to year $g - 1$, pre-treatment, with the average outcome evolution of the control group across the same periods.
